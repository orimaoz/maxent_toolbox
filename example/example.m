...
% the normalization factor was added to the model structure. Wang-landau also approximated the model entropy, let's
% compare it to the entropy of the empirical dataset
empirical_distribution = getEmpiricalModel(samples_test);
