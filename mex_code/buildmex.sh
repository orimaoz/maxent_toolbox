...
SUPPORT_FILES="maxent_functions.cpp matlab_utils.cpp mtrand.cpp IsingEnergy.cpp  MerpSparseEnergy.cpp MerpFastEnergy.cpp KSyncEnergy.cpp KIsingEnergy.cpp IndependentEnergy.cpp EnergyFunctionFactory.cpp"
