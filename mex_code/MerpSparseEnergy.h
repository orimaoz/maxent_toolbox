...
public:
	...
	MerpSparseEnergy(float* in_W, double * in_lambda, uint32_t ncells, uint32_t nfactors, float * in_thresholds, double bStochasticSlope = 0);
...
private:
	...
	DECLARE_ALIGNED float ** m_W_val ALIGN_AFTER;		// sparse columns of W (values)
	...
	DECLARE_ALIGNED double m_energy_diff ALIGN_AFTER;
