// Class that implements a K-synchrony model energy function
#include "EnergyFunction.h"
#include <vector>
#pragma once

class KSyncEnergy : public EnergyFunction
{
public:

	// Constructor - constructs it with a set of factors
	KSyncEnergy(uint32_t nfactors, double * factors);
...
private:
	...
	uint32_t m_nbitson;  // number of bits in x that are currently on
	double m_energy;
	double m_logz;
